        ...
        <div className="min-h-screen flex flex-col items-center justify-center p-6 bg-slate-950 text-white relative overflow-hidden font-display">
            ...
            <div className="z-10 w-full max-w-md">
                <div className="flex flex-col items-center mb-10">
                    ...
                    <h1 className="text-2xl font-black italic uppercase tracking-tighter bg-gradient-to-r from-white to-slate-400 bg-clip-text text-transparent">Elite Performance</h1>
